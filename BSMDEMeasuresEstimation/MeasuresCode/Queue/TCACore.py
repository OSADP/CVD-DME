...
def set_logger(console_level = logging.INFO, file_level = logging.DEBUG, include_file = True, append_file = False, filename = 'me_queue.log'):
...
file_path = dir_path + '/' + 'me_queue.log'
